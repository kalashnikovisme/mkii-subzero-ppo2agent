...
if __name__ == "__main__":
    ...
    model = PPO2.load("training_checkpoints/2.4m.zip", tensorboard_log="./tboard_log")
    model.set_env(env)

    total_timesteps = 1000000
    save_freq = total_timesteps / 100

    checkpoint_callback = CheckpointCallback(save_freq=save_freq, save_path='./training_checkpoints',
